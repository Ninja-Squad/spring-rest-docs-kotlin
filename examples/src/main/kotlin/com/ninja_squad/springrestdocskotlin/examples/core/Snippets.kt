...
import com.ninja_squad.springrestdocskotlin.core.*
 ...
 */
val exampleFields: ResponseFieldsSnippet = responseFieldsSnippet(relaxed = true, subsectionExtractor = beneathPath("body")) {
    // positional
    add("id", "the user ID")
